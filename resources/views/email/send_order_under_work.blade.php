    ...
    <tbody>
        ...
        @if(isset($data['reason']))
            <tr>
                ...
                <p style="font-size:14px;margin:0 0 6px 0;">
                    <span style="font-weight:bold;display:inline-block;min-width:150px">السبب</span>
                    <b style="color:rgb(231, 52, 12);font-weight:normal;margin:0">{{ $data['reason'] }}</b>
                    </p>
                </td>
            </tr>
        @endif
      @if(isset($data['details']))
        <tr>
            <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;">
            <p style="font-size:14px;margin:0 0 6px 0;">
                <span style="font-weight:bold;display:inline-block;min-width:150px">الملاحظات</span>
